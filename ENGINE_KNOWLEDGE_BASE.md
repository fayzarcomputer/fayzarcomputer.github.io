...
- **`executeGeminiRequest()` (L875-L1210):** এপিআই কল এক্সিকিউটর।
  ...
  - L1021: **৩.৫ সেকেন্ড ফাস্ট কানেক্ট টাইমআউট** এবং **৮.০ সেকেন্ড স্ট্রিমিং আইডল টাইমআউট**—সার্ভার হ্যাং এড়াতে তাৎক্ষণিক রোটেশন।
  - L1035-L1082: ৪২৯ কোটা শেষ বা ৫0৩ পেলে কোনো অপেক্ষা ছাড়া **০ms তাৎক্ষণিক পরবর্তী কিতে সুইচ (Zero-Delay Instant Failover)** এবং ৬০ সেকেন্ড সেশন কুলডাউন।
  - স্ক্রিন মেসেজ ক্লিন ও প্রফেশনাল রাখা, সরাসরি কি নম্বর দেখানো (`[কি #২ কোটা শেষ, ০ সেকেন্ডে কি #৩ দিয়ে চেষ্টা চলছে...]`) এবং সেটিংস মোডালে ১-ক্লিক `📋 অডিট লগ ডাউনলোড` বোতাম প্রদান।
