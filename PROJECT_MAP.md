...
| **গিটহ্যাব সিঙ্ক ও ব্যাকআপ টুলস** | `UPDATE_TO_GITHUB.bat`<br>`scripts/sync_to_github.py`<br>`version.json` | ডাবল ক্লিকে সম্পূর্ণ অফলাইন কোড স্বয়ংক্রিয়ভাবে গিটহাবে পুশ ও লাইভ আপডেট ব্যবস্থা |
