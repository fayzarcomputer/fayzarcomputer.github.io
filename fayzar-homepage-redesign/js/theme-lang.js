...
(function () {
  ...
  let currentTheme = localStorage.getItem('fayzar_theme') || 'light';
  ...
  function applyTheme(theme) {
    ...
    if (theme === 'dark') {
      ...
      const label = translations[currentLang].theme_day;
      ...
      const label = translations[currentLang].theme_night;
      if (themeText) themeText.textContent = label;
      if (mobileThemeText) mobileThemeText.textContent = label;
    }
  }
  ...
  function applyLanguage(lang) {
    ...
    if (btnBn && btnEn) {
      if (lang === 'bn') {
        btnBn.className = 'px-2.5 py-0.5 bg-white text-[#075e24] font-bold cursor-pointer transition';
        btnEn.className = 'px-2.5 py-0.5 bg-[#05461b] text-white font-bold hover:bg-white hover:text-[#075e24] cursor-pointer transition';
      } else {
        btnBn.className = 'px-2.5 py-0.5 bg-[#05461b] text-white font-bold hover:bg-white hover:text-[#075e24] cursor-pointer transition';
        btnEn.className = 'px-2.5 py-0.5 bg-white text-[#075e24] font-bold cursor-pointer transition';
      }
    }
