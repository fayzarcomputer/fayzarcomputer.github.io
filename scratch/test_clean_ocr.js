...
global.document = { readyState: 'complete', getElementById: () => null, querySelector: () => null, addEventListener: () => {} };
require('../js/bangla-converter-engine.js');
require('../js/equation-converter.js');
require('../js/docx-handler.js');

// Load ai-ocr-engine
eval(fs.readFileSync('./js/ai-ocr-engine.js', 'utf-8'));
...
const cleaned = FayzarAiOcrEngine.cleanOcrResponse(sampleText);
console.log("=== OUTPUT OF cleanOcrResponse ===");
console.log(cleaned);
